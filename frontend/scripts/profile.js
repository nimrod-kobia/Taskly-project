...
async function renderProfile() {
  ...
  document.getElementById('userName').textContent = user.fullName// replace with display name if available
  ...
  document.getElementById('fullName').value = fullName// replace with display name if available
